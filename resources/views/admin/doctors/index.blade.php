            ...
            <div class="col-12 d-flex justify-content-center">
                <div class="bg-white rounded-5 text-center">
                    ...
                    <div class="row mt-4">
                        <div class="col">
                            <h5>Visualizza</h5>
                            <a class="btn btn-info btn-sm" title="Visualizza profilo" href="{{ route('admin.doctors.show', $doctor->id) }}"><i class="fas fa-eye"></i></a>
                        </div>
                        <div class="col">
                            <h5>Modifica</h5>
                            <a class="btn btn-warning btn-sm" title="Modifica profilo" href="{{ route('admin.doctors.edit', $doctor->id) }}"><i class="fas fa-pen"></i></a>
                        </div>
                    </div>
